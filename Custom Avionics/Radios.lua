...
function draw() 
  if get(batteryON) > 0 then
	drawAll(components) 
	drawText(font_led_32,  0, 232, string.format("%.2f", 0.01*get(COM1) ), 1,1,1)
	drawText(font_led_32, 110, 232, string.format("%.2f", get(COM1_SBY_M)+0.001*get(COM1_SBY_k) ), 0.9,0.9,0.9)
	drawText(font_led_32, 240, 232, string.format("%.2f", 0.01*get(NAV1) ), 1,1,1)
	drawText(font_led_32, 350, 232, string.format("%.2f", get(NAV1_SBY_M)+0.01*get(NAV1_SBY_k) ), 0.9,0.9,0.9)
	drawText(font_led_32,  40, 200, string.format("%.2f", 0.01*get(COM2) ), 1,0.1,0.1)
	drawText(font_led_32, 170, 200, string.format("%.2f", get(COM2_SBY_M)+0.001*get(COM2_SBY_k) ), 0.7,0.0,0.0)
  ...
  end -- of if get(batteryON) > 0 then	
end
